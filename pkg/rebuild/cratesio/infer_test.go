			...
			wantFn: func(repo *gitxtest.Repository) rebuild.Strategy {
				return &CratesIOCargoPackage{
					...
					ExplicitLockfile: &ExplicitLockfile{
						LockfileBase64: "IyBUaGlzIGZpbGUgaXMgYXV0b21hdGljYWxseSBAZ2VuZXJhdGVkIGJ5IENhcmdvLgojIEl0IGlzIG5vdCBpbnRlbmRlZCBmb3IgbWFudWFsIGVkaXRpbmcuCnZlcnNpb24gPSAzCg==",
					},
				}
			},
		},
...
`)},
			...
			wantErr: true, // Should error when registry service returns empty commit
		},
		{
