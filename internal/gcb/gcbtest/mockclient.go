...
type MockLogsClient struct {
	ReadBuildLogsFunc func(ctx context.Context, bucket, buildID string) (io.ReadCloser, error)
	ReadStepLogsFunc  func(ctx context.Context, bucket, buildID string, stepIndex int) (io.ReadCloser, error)
	ListStepLogsFunc  func(ctx context.Context, bucket, buildID string) (int, error)
}

func (mlc *MockLogsClient) ReadBuildLogs(ctx context.Context, bucket, buildID string) (io.ReadCloser, error) {
	return mlc.ReadBuildLogsFunc(ctx, bucket, buildID)
}

func (mlc *MockLogsClient) ReadStepLogs(ctx context.Context, bucket, buildID string, stepIndex int) (io.ReadCloser, error) {
	return mlc.ReadStepLogsFunc(ctx, bucket, buildID, stepIndex)
}

func (mlc *MockLogsClient) ListStepLogs(ctx context.Context, bucket, buildID string) (int, error) {
	return mlc.ListStepLogsFunc(ctx, bucket, buildID)
}
